...
void GroundElementsConfigurator::set(
  ...
  elementsConfiguration.clear();
  //configuration 4
  stairs.setPosition(768 + translationX, 422);
  ...
  blockTriple.setPosition(352 + translationX, 550);
